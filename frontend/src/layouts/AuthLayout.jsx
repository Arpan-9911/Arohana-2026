    ...
    ">
      ...
      <div className="
        ...
        >
          ...
          <div
            className={`
            flex flex-col justify-center p-6 md:p-6 py-10 backdrop-blur-xl 
            ${reverse ? "md:order-2" : "md:order-1"}
          `}
          >
            <div className="max-w-md py-[-100px] mx-auto w-full">
              <img src={image}  className="w-200 md:w-200 mx-auto"/>
